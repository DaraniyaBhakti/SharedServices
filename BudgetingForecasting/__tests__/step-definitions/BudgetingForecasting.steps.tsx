...
const loginData = {meta: {token:"eyJhbGciOiJIUzUxMiJ9.eyJpZCI6MywiZXhwIjoxNjcyMjI2OTIyLCJ0b2tlbl90eXBlIjoibG9naW4ifQ.rfMUt1EWQVOkOO_1_uFKWRvyeRkQOUlqVv-rroSoZRDkIeVLESv_bxx2-ICngxogps6fmzOztLc82JR80m_9KA",id: 3,},};
...
defineFeature(feature, (test) => {
  ...
  test("User navigates to BudgetingForecasting", ({ given, when, then }) => {
    ...
    then("BudgetingForecasting will load with out errors", () => {
      let container = component.findWhere((node) => node.prop("testID") === "container",);
    ...
    then("I can leave the screen with out errors", () => {instance.componentWillUnmount();expect(component).toBeTruthy();
    });
  });
});
